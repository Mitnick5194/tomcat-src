...
public class Catalina {
    ...
    /** 这里并没有读取server.xml文件，只是添加一系列的与server.xml节点对的上的规则罢了
    ...
    /** 重要方法，读取server.xml文件，然后构造Server对象
    ...
    public void load() {
        ...
        try {
            try {
                file = configFile(); //读入配置文件conf/server.xml
            ...
            try {
                ...
                digester.push(this);
                digester.parse(inputSource); //重点 执行完这里 server构造完
